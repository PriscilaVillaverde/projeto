...
addTechBtn.addEventListener('click', function (ev){
    ...
    constexpLabel1 = createLabel('0-2 anos',id1)
    const expLabe2 = createLabel('Experiencia:')
    const id2 = 'expRadio-' + rowIndex + '.2'
    const expRadio2 = createInput(id2, '3-4 anos', 'techExp-' + rowIndex, 'radio')
    constexpLabel2 = createLabel('3-4 anos',id2)
    const expLabe3 = createLabel('Experiencia:')
    const id3 = 'expRadio-' + rowIndex + '.3'
    const expRadio3 = createInput(id3, '5 + anos', 'techExp-' + rowIndex, 'radio')
    constexpLabel3 = createLabel('5 + anos',id3)
...
form.addEventListener('submit', function(ev){
    ...
    inputRows.forEach(function(row){
        ...
        technologie.push({name: techName, exp: techExp})
